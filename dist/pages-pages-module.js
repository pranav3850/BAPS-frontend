    ...
    ForgotPwdComponent.prototype.login = function (data) {
        ...
        this.loginService.userLogin(data).subscribe(function (res) {
            if (res == 1) {
                ...
                _this.apiService.showNotification('top', 'right', 'Login successfully', 'sucess');
...
/* harmony import */ var _login_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login.model */ "cqlc");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(element, router) {
        this.element = element;
        this.router = router;
        this.test = new Date();
        this.loginModel = new _login_model__WEBPACK_IMPORTED_MODULE_3__["Loginuser"];
        this.OTPSent = false;
