...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.getHaribhaktDetailsById = function () {
        return this.httpClient.get(app_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"].getHaribhaktInfoURL);
    };
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.viewFamilyMembersDetails = function (id) {
        var _this = this;
        this.viewMembers = [];
        this.totalHaribhakt.forEach(function (element) {
            if (element.familyId == id) {
                _this.viewMembers.push(element);
            }
            for (var i = 0; i < _this.viewMembers.length; i++) {
                _this.viewMembers[i].index = i + 1;
            }
        });
    };
    ...
    DashboardComponent.prototype.getRedTickListForAll = function () {
        var _this = this;
        this.dashboardService.getHaribhaktDetailsById().subscribe(function (data) {
            _this.tRedList = data;
            // this.offer = data;
