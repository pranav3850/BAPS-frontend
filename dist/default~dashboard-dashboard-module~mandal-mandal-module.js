(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboard-dashboard-module~mandal-mandal-module"],{

/***/ "HGi0":
/*!*****************************************!*\
  !*** ./src/app/mandal/madal.routing.ts ***!
  \*****************************************/
/*! exports provided: MandalRoutes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MandalRoutes", function() { return MandalRoutes; });
/* harmony import */ var _mandal_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mandal.component */ "wE+Y");

var MandalRoutes = [{
        path: '',
        children: [{
                path: 'mandal',
                component: _mandal_component__WEBPACK_IMPORTED_MODULE_0__["MandalComponent"]
            }]
    }];
...
/***/ "PEQ8":
/*!*********************************************!*\
  !*** ./src/app/mandal/mandal.component.css ***!
  \*********************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21hbmRhbC9tYW5kYWwuY29tcG9uZW50LmNzcyJ9 */");
...
/***/ "VJFv":
/*!*****************************************!*\
  !*** ./src/app/mandal/mandal.module.ts ***!
  \*****************************************/
/*! exports provided: MandalModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MandalModule", function() { return MandalModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _mandal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mandal.component */ "wE+Y");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _madal_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./madal.routing */ "HGi0");
...
var MandalModule = /** @class */ (function () {
    function MandalModule() {
    }
    MandalModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_mandal_component__WEBPACK_IMPORTED_MODULE_2__["MandalComponent"]],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_madal_routing__WEBPACK_IMPORTED_MODULE_4__["MandalRoutes"]),
                _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"],
                app_material_material_module__WEBPACK_IMPORTED_MODULE_6__["MaterialModule"],
                ngx_pagination__WEBPACK_IMPORTED_MODULE_7__["NgxPaginationModule"]
            ],
            exports: [
                _mandal_component__WEBPACK_IMPORTED_MODULE_2__["MandalComponent"]
            ]
        })
    ], MandalModule);
    return MandalModule;
...
/***/ "fyEh":
/*!*******************************************!*\
  !*** ./src/app/dashboard/mandal.model.ts ***!
  \*******************************************/
/*! exports provided: Mandal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Mandal", function() { return Mandal; });
var Mandal = /** @class */ (function () {
    function Mandal(id, name, mandaltype) {
        this.id = id;
        this.name = name;
...
/***/ "owRe":
/*!************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/mandal/mandal.component.html ***!
  \************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var app_dashboard_mandal_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/dashboard/mandal.model */ "fyEh");
...
var MandalComponent = /** @class */ (function () {
    function MandalComponent(dashboardService, apiService) {
        this.dashboardService = dashboardService;
        this.apiService = apiService;
        this.MandalModel = new app_dashboard_mandal_model__WEBPACK_IMPORTED_MODULE_5__["Mandal"];
        this.updateMandalModel = new app_dashboard_mandal_model__WEBPACK_IMPORTED_MODULE_5__["Mandal"];
        this.mandalList = [];
        this.allMandalList = [];
        this.search = '';
        this.tMandal = [];
        this.openMandalTypeText = false;
    }
    MandalComponent.prototype.ngOnInit = function () {
        this.getMandalType();
        this.getAllmandal();
    };
    MandalComponent.prototype.getMandalType = function () {
        var _this = this;
        this.dashboardService.getAllMandaltypeList().subscribe(function (data) {
            _this.mandalTypeList = data;
        });
    };
    MandalComponent.prototype.selectedMandalType = function (mandaltype) {
        var _this = this;
        debugger;
        this.mandalTypeList.forEach(function (element) {
            ...
            _this.MandalModel.mandaltype = _this.selectedName;
        });
    };
    MandalComponent.prototype.addMandalType = function () {
        this.openMandalTypeText = true;
    };
    MandalComponent.prototype.saveMandalList = function () {
        var _this = this;
        this.dashboardService.saveMandalDetails(this.MandalModel).subscribe(function (data) {
            _this.MandalList = data;
            _this.getAllmandal();
            _this.apiService.showNotification('top', 'right', 'Mandal Added Successfully.', 'success');
        });
    };
    MandalComponent.prototype.getAllmandal = function () {
        var _this = this;
        this.mandalList = [];
    ...
    MandalComponent.prototype.searchManadalList = function (val) {
        if (this.search == '') {
    ...
    MandalComponent.prototype.transformMandal = function (allMandalList, searchValue) {
        var _this = this;
        this.allMandalList = [];
    ...
    MandalComponent.prototype.removeMandalList = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (result.value == true) {
                _this.dashboardService.removeMandalDetails(id).subscribe(function (req) {
                    _this.apiService.showNotification('top', 'right', 'Mandal removed Successfully.', 'success');
                });
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
                    title: 'Deleted!',
    ...
    MandalComponent.prototype.updateMandalDetails = function (data) {
    ...
    MandalComponent.prototype.updateMandalList = function () {
        var _this = this;
        this.updateMandalModel.mandaltype = this.selectedName;
        this.dashboardService.updateMandalList(this.updateMandalModel).subscribe(function (req) {
            _this.getAllmandal();
            _this.apiService.showNotification('top', 'right', 'Mandal Details Successfully Updated.', 'success');
        });
    };
    MandalComponent.ctorParameters = function () { return [
    ...
    MandalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'app-mandal',
            template: _raw_loader_mandal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_mandal_component_css__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
        __metadata("design:paramtypes", [app_dashboard_dashboard_service__WEBPACK_IMPORTED_MODULE_4__["DashboardService"],
            app_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])
    ], MandalComponent);
    return MandalComponent;
}());
...
//# sourceMappingURL=default~dashboard-dashboard-module~mandal-mandal-module.js.map